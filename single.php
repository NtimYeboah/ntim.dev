...
<!-- Post header-->
<section class="md:w-3/4 md:mx-auto">
...
<!-- Share plugin -->
<section class="md:w-3/4 md:mx-auto m-5 border-b-2 border-t-2 border-slate-200 py-9">
...
<!-- Comments section -->
<section class="md:w-3/4 md:mx-auto giscus mt-5 px-4 md:px-0">
</section>
<!-- End of comments section-->

<!-- Newletter section -->
<section id="action" class="bg-cyan-900 p-5 mt-5">
    <div class="md:w-11/12 md:mx-auto flex flex-col md:flex md:flex-row md:gap-3">
...
?>
<section class="md:w-3/4 md:mx-auto mt-5">
    <div class="flex flex-col items-center">
